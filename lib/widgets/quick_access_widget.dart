      ...
      children: [
        ...
        _buildQuickAccessItem(
          ...
          ColorsMaterial.imageColour,
              () => Navigator.push(context, MaterialPageRoute(builder: (context) => ImageFilesPage())),
        ),
        _buildQuickAccessItem(
          context,
          ...
          ColorsMaterial.videoColour,
              () => Navigator.push(context, MaterialPageRoute(builder: (context) => VideoFilesPage())),
        ),
        _buildQuickAccessItem(
          context,
          ...
          ColorsMaterial.filesColour,
              () => Navigator.push(context, MaterialPageRoute(builder: (context) => OtherFilesPage())),
        ),
      ],
    );
  }
